(function() {
  ...
  ShopifyCart.Models.Base = (function() {
    ...
    Base.prototype.set = function(attrs, options) {
      ...
      for (attr in attrs) {
        ...
        if ((this.hasMany != null) && (this.hasMany[attr] != null)) {
          model = eval("ShopifyCart.Models." + this.hasMany[attr]);
          for (index in value) {
    ...
    Base.prototype.fetch = function() {
      var model;
      model = this;
      return ShopifyCart.sync("GET", this, this.url("GET"), {
    ...
    Base.prototype.save = function() {
      var model;
      model = this;
      return ShopifyCart.sync("POST", this, this.url("POST"), {
        success: function(attributes) {
          return model.set(attributes);
        }
      });
  ...
  ShopifyCart.Models.LineItem = (function() {
    __extends(LineItem, ShopifyCart.Models.Base);
    function LineItem() {
  ...
  ShopifyCart.Models.Cart = (function() {
    __extends(Cart, ShopifyCart.Models.Base);
    function Cart() {
    ...
    Cart.prototype.clear = function() {
      var cart;
      cart = this;
      return ShopifyCart.sync("POST", this, "/cart/clear.js", {
        data: null,
    ...
    Cart.prototype.add = function(id, quantity) {
      var cart;
      cart = this;
      return ShopifyCart.sync("POST", this, "/cart/add.js", {
    ...
    Cart.prototype.remove = function(id) {
      var cart;
      cart = this;
      return ShopifyCart.sync("POST", this, "/cart/change.js", {
        data: "id=" + id,
        success: function(data) {
          return cart.set(data);
        }
  ...
  ShopifyCart.Views.Base = (function() {
  ...
  ShopifyCart.Views.CartView = (function() {
    __extends(CartView, ShopifyCart.Views.Base);
    function CartView() {
    ...
    CartView.prototype.render = function() {
      ...
      _.each(this.model.attributes.items, function(item) {
        return new ShopifyCart.Views.LineItemView({
  ...
  ShopifyCart.Views.LineItemView = (function() {
    __extends(LineItemView, ShopifyCart.Views.Base);
    ...
    LineItemView.prototype.remove = function() {
      jQuery("#" + this.model.attributes.id).remove();
      return this;
    };
